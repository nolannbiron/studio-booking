...
import type { TContactsTableFooterType } from '@/components/contact/table/store/contacts-table.store'
import { useContactsTableStore } from '@/components/contact/table/store/contacts-table.store'
