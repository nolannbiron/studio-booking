...
export default function TaskRow({
	...
	return (
		<div
			className={cn(
				'hover:bg-muted/25 group relative grid h-full w-full cursor-pointer select-none grid-cols-11 items-center overflow-hidden border-b px-6 py-5 first:border-t',
				{
			...
			<div className="col-span-1 flex items-center justify-end gap-2.5">
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button variant="ghost" size="sm" className="text-muted-foreground px-1">
							<FiMoreVertical />
						</Button>
					</DropdownMenuTrigger>
