...
export default function ContactActivityPage(): JSX.Element {
	...
	return (
		<ScrollArea className="h-full max-h-full flex-1 space-y-3 px-6">
			<h2 className="my-5 text-lg font-bold">Activity</h2>
			<div className="text-muted-foreground mb-5 text-base font-medium">2024</div>
			<div className="">
