...
const buttonVariants = cva(
	'focus-visible:ring-ring isolate inline-flex items-center justify-center gap-2 text-sm font-medium transition-all focus:outline-0 focus-visible:outline-0 focus-visible:ring-1 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-60',
	{
		variants: {
			variant: {
				default: [
					'bg-primary relative isolate inline-flex items-center justify-center rounded-lg border border-transparent py-[calc(theme(spacing[1.5])-1px)] text-white  shadow-md focus-visible:ring-white active:pt-2 disabled:opacity-50 sm:py-[calc(theme(spacing[1.5])-1px)] [&>svg]:text-blue-50',
				...
				'outline-placeholder':
					'bg-muted/70 dark:bg-muted/20 border-input hover:bg-input text-foreground/70 dark:text-muted-foreground hover:bg-input border border-dashed shadow-sm',
				secondary:
