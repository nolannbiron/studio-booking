		...
		>
			<div
				...
				className={cn('grid h-full select-none flex-nowrap items-center gap-1', {
					...
					'before:border-ring before:bg-ring/5 dark:before:bg-ring/10 before:pointer-events-none before:absolute before:bottom-px before:left-0 before:right-px before:top-0 before:z-10 before:overflow-hidden before:rounded before:border before:transition-all':
						isActivated
				})}
			>
				{children}
