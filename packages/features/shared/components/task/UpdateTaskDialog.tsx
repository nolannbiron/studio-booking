...
export default function UpdateTaskDialog({
	...
	return (
		<Dialog open={isOpen} onOpenChange={handleOpenChange} {...props}>
			...
			<DialogContent className="top-0 flex max-w-4xl translate-y-0 flex-col gap-0 overflow-hidden p-0 max-md:rounded-none md:top-1/3 md:-translate-y-1/2">
				<DialogHeader className="h-fit border-b px-5 pb-3 pt-4">
					<TaskDialogHeader entityId={formData.entityId} />
				</DialogHeader>
