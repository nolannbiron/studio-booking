...
export default function ContactPage(): JSX.Element {
	...
	useEffect(() => {
		if (
			...
			!pathname.includes(EContactRoutes.LIBRARY) &&
			!pathname.includes(EContactRoutes.NOTES) &&
			!pathname.includes(EContactRoutes.TASKS) &&
			!pathname.includes(EContactRoutes.SESSIONS)
		) {
			navigate(`/contact/${id}/activity`, { replace: true })
		}
	...
	const activeTab = pathname.includes(EContactRoutes.ACTIVITY)
		...
		: pathname.includes(EContactRoutes.NOTES)
			...
			: pathname.includes(EContactRoutes.TASKS)
				...
				: pathname.includes(EContactRoutes.LIBRARY)
					? EContactRoutes.LIBRARY
					: pathname.includes(EContactRoutes.SESSIONS)
						? EContactRoutes.SESSIONS
						: EContactRoutes.ACTIVITY
